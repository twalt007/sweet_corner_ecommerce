...
export default props =>{
    return (
        <div className="services-container">
            <Container fluid>
                <Row>
                    <Col md={7} sm={7} className="text content-col">
                        <div>
                            <h4 className="h4">We cherish the sweet moments...</h4>
                            ...
                            <h4 className="h4">Party Cupcakes</h4>
                            ...
                            <h4 className="h4">Gift Cupcake</h4>
